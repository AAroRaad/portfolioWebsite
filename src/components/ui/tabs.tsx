  ...
  <TabsPrimitive.Trigger
    ...
    className={cn(
      "inline-flex items-center w-full bg-[#27272c] justify-center" +
        "        whitespace-nowrap text-white rounded-lg p-3 text-base text-balance font-medium" +
...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.Content
    ref={ref}
    className={cn(
      "max-h-[480px] ring-offset-white focus-visible:outline-none focus-visible:ring-2 " +
